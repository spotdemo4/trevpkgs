...
buildPythonApplication {
  ...
  src = fetchFromGitHub {
    ...
    repo = "opengrep";
    tag = "v${version}";
    hash = "sha256-mVhtzZ47ghR5q4io6/YThC4liIUw8F+WOaNFcniNJN0=";
